...
type VerifierClient interface {
	SubmitVP(ctx context.Context, in *SubmitVPRequest, opts ...grpc.CallOption) (*SubmitVPResponse, error)
}
...
func (c *verifierClient) SubmitVP(ctx context.Context, in *SubmitVPRequest, opts ...grpc.CallOption) (*SubmitVPResponse, error) {
	out := new(SubmitVPResponse)
	err := c.cc.Invoke(ctx, "/verifier.Verifier/SubmitVP", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VerifierServer interface {
	SubmitVP(context.Context, *SubmitVPRequest) (*SubmitVPResponse, error)
...
func (UnimplementedVerifierServer) SubmitVP(context.Context, *SubmitVPRequest) (*SubmitVPResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitVP not implemented")
}
...
func _Verifier_SubmitVP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmitVPRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VerifierServer).SubmitVP(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/verifier.Verifier/SubmitVP",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VerifierServer).SubmitVP(ctx, req.(*SubmitVPRequest))
	}
...
var Verifier_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SubmitVP",
			Handler:    _Verifier_SubmitVP_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protos/verifier.proto",
}
